...
public class PanelDatosSegmento extends JPanel implements ActionListener{
	...
	public void update(DatosActividad datosActividad)  {
		...
		if (datosActividad.getTrack().isAltitud()) {
		...
		if (datosActividad.getTrack().isHr()) bloqueHR.setVisible(true);
		else bloqueHR.setVisible(false);

		if (datosActividad.getTrack().isCadencia()) bloqueCadencia.setVisible(true);
		else bloqueCadencia.setVisible(false);

		if (datosActividad.getTrack().isPotencia()) bloquePotencia.setVisible(true);
